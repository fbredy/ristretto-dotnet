...
namespace Ristretto.Test
{
    ...
    public class RistrettoElementTest
    {
        ...
        static readonly string[] INVALID_ENCODINGS = new [] {
        ...
        static readonly string[] FROM_UNIFORM_BYTES_INPUTS = new [] {
        ...
        static readonly string[] FROM_UNIFORM_BYTES_OUTPUTS = new [] {
        ...
        public void generatorDecompressionCompression()
        {
            ...
            Assert.AreEqual(Constants.RISTRETTO_GENERATOR, B);
            Assert.AreEqual(RISTRETTO_GENERATOR_COMPRESSED, B.Compress());
        }

        //[TestMethod]
        //public void generatorSerializeDeserialize()
        //{
        ...
        public void equalityRequiresSameClass()
        {
            ...
            EdwardsPoint P = B.Representation;
            Assert.IsFalse(B.Equals(P));
        }
        ...
        {
            RistrettoElement P = Constants.RISTRETTO_GENERATOR.Doubling().Doubling().Doubling().Doubling();
        ...
        {
            Assert.AreEqual(RistrettoElement.IDENTITY.Subtract(Constants.RISTRETTO_GENERATOR),
                Constants.RISTRETTO_GENERATOR.Negate());
        }
