namespace Ristretto
{
    ...
    {
        /// <summary>
        /// The order of the Ed25519 basepoint, ℓ = 2^{252} +         * 27742317777372353535851937790883648493.
        /// </summary>
        ...
        /// <summary>
        /// = √{a*d - 1}, where a = -1 mod p, d are the Edwards curve parameters.
        /// </summary>
        ...
        /// <summary>
        /// = 1/√{a-d}, where a = -1 mod p, d are the Edwards curve parameters.
        /// </summary>
